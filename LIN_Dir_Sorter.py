...
If that run is stuck, close it with: kill -9 <PID>
...
If that process is still stuck, close it with: kill -9 {lock_pid}
""")
...
def configure_interactively(path: Path) -> None:
    ...
    while True:
        ...
        while True:
            ...
            system("clear")  # Clear screen after editing before showing menu again
